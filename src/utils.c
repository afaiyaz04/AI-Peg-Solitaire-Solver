...
void execute_move_t(state_t* state, position_s* selected_peg, move_t jump) {
	...
	// Change made by Ahbab Faiyaz
	// Moving the cursor to the selected peg before making the move
	state->cursor.x = x;
	state->cursor.y = y;
...
/* Fuction made by Alistair Moffat */
/* Function to initialize a list to track the start and end of path */
...
/* Fuction made by Alistair Moffat and edited by Ahbab Faiyaz*/
/* Function to attach node at the starting of the list */
void insert_at_head(list_t *list, node_t *data){
